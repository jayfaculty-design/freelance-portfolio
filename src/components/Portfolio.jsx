...
const Portfolio = () => {
  ...
  return (
    <div className="mt-24 sm:mt-28 md:mt-32 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto mb-8 sm:mb-10 md:mb-12">
      ...
      <ScrollReveal direction="up" delay={0.1} distance={30}>
        ...
        >
          ...
          <ScrollReveal direction="up" delay={0.3} distance={20}>
            ...
            >
              My step-by-step guide ensures a seamless project experience, from
              the first consultation to final delivery. I handle every detail,
      ...
      <ScrollReveal direction="up" delay={0.3} distance={40} threshold={0.1}>
        <div
            ...
            <div className="text-center">
              ...
              <p
                className="text-[14px] sm:text-[15px] md:text-[16px] 
                  ...
                  mx-auto"
              >
                My development process is designed to deliver high-quality
                results efficiently and transparently.
              </p>
            </div>
          </ScrollReveal>
