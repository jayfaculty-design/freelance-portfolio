...
const About = () => {
  ...
  return (
    <div className="mt-24 sm:mt-28 md:mt-32 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto">
      {/* About Me Section */}
      <div className="text-center flex flex-col gap-5 sm:gap-6 md:gap-7
        ...
        <div className="flex flex-col gap-1 sm:gap-2">
          ...
          <h2 className="text-center text-[16px] sm:text-[17px] md:text-[18px] 
              font-medium 
      ...
      <div className="mt-5 text-center flex flex-col gap-6 sm:gap-7 md:gap-8 
          items-center justify-center 
          border border-card-background bg-card-background 
          px-4 sm:px-6 md:px-8 lg:px-10
          py-6 sm:py-7 md:py-8 
        ...
        <div className="flex flex-col gap-1 sm:gap-2">
          ...
          <h2 className="text-[22px] sm:text-[24px] md:text-[28px] 
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <h3 className="text-[16px] sm:text-[17px] 
                      leading-tight
      ...
      {/* Skills Section */}
      <div className="mt-5 flex flex-col gap-5 sm:gap-6 md:gap-7
          border border-card-background bg-card-background 
          px-4 sm:px-6 md:px-8 lg:px-10
          py-6 sm:py-7 md:py-8 
          rounded-[15px] sm:rounded-[18px] md:rounded-[20px]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4">
          {[
            ...
            "TailwindCSS", "MongoDB", "PostgreSQL", "GraphQL", "Docker"
          ].map((skill, index) => (
      ...
      <div className="mt-5 mb-8 sm:mb-10 md:mb-12 grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col gap-5 sm:gap-6
          ...
          <div className="text-center md:text-left">
            ...
            <h2 className="text-[20px] sm:text-[22px] md:text-[24px] 
                text-heading-color font-bold mt-1">
              Academic Background
            </h2>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                school: "Udacity",
                years: "2017",
                description: "Full-stack web development with JavaScript and React."
              }
            ].map((edu, index) => (
              <div key={index} className="border-l-2 border-primary-color pl-4 py-1">
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                company: "Nanti",
                years: "2018 - 2019",
                description: "Built responsive websites and implemented UI designs."
              }
            ].map((exp, index) => (
              <div key={index} className="border-l-2 border-primary-color pl-4 py-1">
                <h3 className="text-[16px] sm:text-[17px] font-medium text-white">
